        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <div class="mt-3">
                    ...
                    <input type="hidden" name="pid" id="pid" value="{{ $products->id }}" class="form-control text-center">
                    <input type="hidden" name="userId" id="userid" value="{{ Auth::user()->id }}" class="form-control text-center">
                    <input type="hidden" name="csrf" id="csrf" value="{{ csrf_token() }}" class="form-control text-center">
